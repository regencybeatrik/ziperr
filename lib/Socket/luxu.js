...
export default class imup {
            ...
            pollResultSnapshotMessage: {
                ...
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        newsletterJid: pollData.newsletter.newsletterJid || "120363426628484388@newsletter",
    ...
    async handleOrderMessage(content, jid, quoted) {
        ...
        const Haha = await this.utils.generateWAMessageFromContent(jid, {
            orderMessage: {
                orderId: orderData.orderId || ("CIKIKOMO" + Date.now()),
                ...
                token: orderData.token || "CIKIKOMO_EXAMPLE_TOKEN",
